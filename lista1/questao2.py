"""2) Efetuar o cálculo da quantidade de litros de combustível gasta em uma viagem, utilizando um automóvel que
...
tempo = float( input("Tempo da viagem (horas): "))
...
print(f"Distancia a percorrer: {distancia}")

litros = distancia/ 12
print(f"Combustivel necessário: {litros} litros")
